    ...
    public class Worker : BackgroundService
    {
        ...
        protected override async Task ExecuteAsync(CancellationToken stoppingToken)
        {
            ...
            while (!stoppingToken.IsCancellationRequested)
            {
                ...
                if (serviceRunScheduleProvider.ShouldRun(nameof(CatalogSpamService)))
                {
                    ...
                    await serviceRunHistoryHandler.RegisterStartAsync(nameof(CatalogSpamService), GetType().Assembly.GetName().Version.ToString());
                    ...
                    {
                        stopWatch.Stop();
                        await serviceRunHistoryHandler.RegisterFinishAsync(nameof(CatalogSpamService), additionalInfo, status, $"{stopWatch.ElapsedMilliseconds} ms");
                        stopWatch.Reset();
                    }
