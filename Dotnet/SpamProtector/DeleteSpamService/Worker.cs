    ...
    public class Worker : BackgroundService
    {
        ...
        protected override async Task ExecuteAsync(CancellationToken stoppingToken)
        {
            ...
            while (!stoppingToken.IsCancellationRequested)
            {
                ...
                if (serviceRunScheduleProvider.ShouldRun(nameof(DeleteSpamService)))
                {
                    ...
                    await serviceRunHistoryHandler.RegisterStartAsync(nameof(DeleteSpamService), GetType().Assembly.GetName().Version.ToString());
                    ...
                    {
                        stopWatch.Stop();
                        await serviceRunHistoryHandler.RegisterFinishAsync(nameof(DeleteSpamService), additionalInfo, status, $"{stopWatch.ElapsedMilliseconds} ms");
                        stopWatch.Reset();
                    }
